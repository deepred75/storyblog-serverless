...
Web app ini fully responsive menggunakan plugin Tailwind css dibuat dengan Nuxt dan component Vue, di deploy secara statis html di shared hosting dengan permalink yang SEO friendly 😎
